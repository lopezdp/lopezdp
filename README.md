...
My name is David P. Lopez and I'm a fullstack software engineer with experience building machine learning applications to reduce payments fraud. I'm from the USA, and I live in Latin America while working for NativeStack, Inc. You can find me on <div style="width:50%">[![StackOverflow][1.2]][1]</div>, and you can view a third party assessment of the work I have committed my repositories on <div style="width:50%">[![Coder's Rank][2.2]][2]</div>.
